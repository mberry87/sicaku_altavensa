...
<body>
    ...
    <div id="main-wrapper">
            ...
            <div class="brand-logo">
                <a href="{{ url('/home') }}">
                    ...
                    <span class="brand-title">
                        <img src="{{ asset('gambar/sistem/logo1.png') }}" alt="" style="height: 25px">
                        <span class="text-white ">SI<b>CAKU</b></span>
                    </span>
                </a>
            </div>
        </div>
                    ...
                    <ul class="clearfix">
                        ...
                        <li class="icons">
                            <div class="user-img c-pointer position-relative">
                                ...
                                @if (Auth::user()->foto == '')
                                    <img src="{{ asset('gambar/sistem/user.png') }}" height="40" width="40"
                                        alt="">
                                @else
        ...
        <div class="nk-sidebar">
            ...
            <div class="p-3 profil_admin">
                <div class="media align-items-center mb-1 mt-3">
                    @if (Auth::user()->foto == '')
                        <img class="mr-2" src="{{ asset('gambar/sistem/user.png') }}" height="60" width="60"
                            alt="">
                    @else
        ...
        <div class="footer">
            <div class="copyright">
                <p>Copyright &copy; Aplikasi Keuangan Menggunakan Laravel. by <a href="" target="_blank"></a>
                    {{ date('Y') }}</p>
            </div>
        </div>
    </div>
    ...
    <script src="{{ asset('asset_admin/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') }}">
    </script>
